<%@ Page Language="C#" MasterPageFile="~/SubSiteBase.Master" AutoEventWireup="true" CodeFile="Video7.aspx.cs" Inherits="LovRubWeb.Videos.Video7" Title="LovRub - Videos" %>
    ...
    <div class="rightcol">
        ...
        <strong>
            ...
            <div id="vidPlayerContainer">
                <uc2:VidPlayer id="VidPlayer1" runat="server" ThumbPath="Valentines_Thumbnail.jpg" VidPath="Valentines Day Regular-LOVRUBFINAL1-h.264 lovrub.flv">
                </uc2:VidPlayer>
            </div>
