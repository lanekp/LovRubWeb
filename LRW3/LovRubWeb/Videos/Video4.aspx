<%@ Page Language="C#" MasterPageFile="~/SubSiteBase.Master" AutoEventWireup="true" CodeFile="Video4.aspx.cs" Inherits="LovRubWeb.Videos.Video4" Title="LovRub - Videos" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContent" runat="server">
    <div class="rightcol">
        ...
        <h1 class="pagetitle">Video<strong><asp:HyperLink runat="server" NavigateUrl="~/Videos/Default.aspx">Back to Videos</asp:HyperLink></strong></h1>
        
            <div id="vidPlayerContainer">
                <uc2:VidPlayer id="VidPlayer1" runat="server" ThumbPath="120-thumb.jpg" VidPath="120.flv">
                </uc2:VidPlayer>
            </div>
