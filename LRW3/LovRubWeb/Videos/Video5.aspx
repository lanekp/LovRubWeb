<%@ Page Language="C#" MasterPageFile="~/SubSiteBase.Master" AutoEventWireup="true" CodeFile="Video5.aspx.cs" Inherits="LovRubWeb.Videos.Video5" Title="LovRub - Videos" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cphContent" runat="server">
    <div class="rightcol">
        ...
        <strong>
            <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/Videos/Default.aspx">Back to Videos</asp:HyperLink>
        </strong></h1>
        
            <div id="vidPlayerContainer">
                <uc2:VidPlayer id="VidPlayer1" runat="server" ThumbPath="ChristmasThumb.jpg" VidPath="Christmas Regular.flv">
                </uc2:VidPlayer>
            </div>
