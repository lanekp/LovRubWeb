<%@ Page Language="C#" MasterPageFile="~/SubSiteBase.Master" AutoEventWireup="true" CodeFile="Video2.aspx.cs" Inherits="LovRubWeb.Videos.Video2" Title="LovRub - Videos" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphSubMenu" runat="server">
    ...
    <asp:HyperLink runat="server" NavigateUrl="~/Products/Default.aspx" ImageUrl="~/images/ordernow.jpg"></asp:HyperLink>
    ...
    <div class="rightcol">
        ...
        <asp:HyperLink runat="server" NavigateUrl="~/Videos/Default.aspx">Back to Videos</asp:HyperLink>	                
            ...
            <div id="vidPlayerContainer">
                <uc2:VidPlayer id="VidPlayer1" runat="server" ThumbPath="LovRub-Office-SS.jpg" VidPath="Office Regular-LOVRUBFINAL1-h.264 lovrub.flv">
                </uc2:VidPlayer>                 
