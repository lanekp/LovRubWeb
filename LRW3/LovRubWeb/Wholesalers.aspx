<%@ Page Language="C#" MasterPageFile="~/siteBase.Master" AutoEventWireup="true" CodeFile="Wholesalers.aspx.cs" Inherits="LovRubWeb.Wholesalers" Title="LovRub - Wholesalers" %>
...
<div class="rightwcol" style="background: url(images/bi-wholesalers.jpg) no-repeat top right;">
        <div id="wholesaleVidContainer">
            ...
            <div style="margin: 480px 0 0 0;">
                <a id="ctl00_cphContent_HyperLink11" href="http://lovrub.com/Videos/Video2.aspx"><img src="http://lovrub.com/videos/Info-smallthumb.jpg" style="border-width:0px;" /></a>
                <a id="ctl00_cphContent_HyperLink12" href="http://lovrub.com/Videos/Video2.aspx">30 Minute Infomercial</a>                
            </div>
        </div>
        <div class="imagedContent" style="padding-top:75px; margin:-700px 0 500px 0;;">
