 ...
 */
                ...
                sb.Append("<table width=585 cellpadding=4 cellspacing=0>");
                ...
                sb.Append("<tr style='border:1px solid #cccccc; background-color:#CCC'><td><b>Item Number</b></td><td><b>Item</b></td><td><b>Quantity</b></td><td><b>Price</b></td><td><b>Total<b></td></tr>");
                ...
                string appendFormat = "<tr bgcolor=#FFFFFF><Td>{0}</td><td>{1}</td><td>{2}</td><td align=right>{3}</td><td align=right>{4}</td></tr>";
                string appendAltFormat = "<tr bgcolor=#FFFFFF><Td>{0}</td><td>{1}</td><td>{2}</td><td align=right>{3}</td><Td align=right>{4}</td></tr>";

                /*sb.Append("<table width=585 cellpadding=4 cellspacing=0>");
                sb.Append("<tr style='border:1px solid #cccccc; ><td><b>Item Number</b></td><td><b>Item</b></td><td><b>Quantity</b></td><td><b>Price</b></td><td><b>Total<b></td></tr>");

                string appendFormat = "<tr><Td>{0}</td><td>{1}</td><td>{2}</td><td align=right>{3}</td><td align=right>{4}</td></tr>";
                string appendAltFormat = "<tr><Td>{0}</td><td>{1}</td><td>{2}</td><td align=right>{3}</td><Td align=right>{4}</td></tr>";
                 */
