<%@ Page Language="C#" Theme="Admin" StylesheetTheme="Admin" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="Admin_Reviews.aspx.cs" Inherits="Admin_Admin_Reviews" Title="Product Reviews Administration" %>
