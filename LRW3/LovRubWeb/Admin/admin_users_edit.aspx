<%@ Page Language="C#" Theme="Admin" StylesheetTheme="Admin" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="admin_users_edit.aspx.cs" Inherits="admin_user_edit" Title="Edit User" %>
        ...
        <td width="62%" height="100%" class="lbBorders">
            ...
            <table class="bodyText" cellspacing="0" width="100%" cellpadding="0" border="0">
                <tr class="callOutStyleLowLeftPadding">
                    <td colspan="4">
                        <h4><asp:literal ID="ActionTitle" runat="server" text="Edit User" /></h4>
                    </td>                    
                </tr>
                    ...
                    <td>
                        <table class="bodyText" bordercolor="#ccddef">
                            <tr>
                                <td width="2"></td>
                                <td colspan="2">
                                    <h5><asp:label runat="server" id="Label3" text="User Details"/></h5>
                                    <br />
                                    <br />                                                                                                
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td width="2"></td>
                                <td colspan="2">
                                    <asp:checkbox runat="server" id="ActiveUser" text="Active User" TabIndex="106"/>
                                </td>
                            </tr>   
                                                        <tr>
                                <td width="2"></td>
                            ...
                            <tr valign="top">
                                ...
                                <td  class="userDetailsWithFontSize" height="100%" colspan="2">
                                    <br />
                                    <h5><asp:label runat="server" id="SelectRolesLabel" text="Select User Roles"/></h5>
                                    <br />
                                    <br />
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3">
                                    <br /><br />
                                    <a href="admin_users.aspx" class="frmbutton">Back to user list.</a>
                                </td>
                            </tr>
                        </table>                        
                    </td>
