...
<script runat="server">
    ...
    protected void Application_BeginRequest(Object sender, EventArgs e) 
    {
		...
		if(System.IO.Path.GetExtension(strCurrentPath).EndsWith("aspx", true, System.Globalization.CultureInfo.InvariantCulture)) 
        {
            ...
            { //no ... redirect. 
                ...
                builder.Host = "www." + Request.Url.Host; Response.Redirect(builder.ToString(), true);
            } 
