...
lastDiv = null;
var returnControl='<%=Utility.GetParameter("cn")%>';
var returnHolder='<%=Utility.GetParameter("ct") %>';
...
<body>
	<iframe style="width:100%;height:100%;border:0;" border=0 frameborder=0 src="ImagePicker.aspx?frame=1&<%=Request.QueryString%>"></iframe>
</body>
</html>
</asp:panel>
