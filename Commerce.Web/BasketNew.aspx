<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="BasketNew.aspx.cs"
  Inherits="BasketNew" Title="Your Shopping Cart" %>
            ...
            <td>
                <asp:Panel ID="pnlCheckout" runat="server">
                    ...
                    <div class="coreboxbody">
                      ...
                      <hr />
                      <asp:HyperLink ID="lnkCheckout" runat="server" NavigateUrl="~/CheckoutNew.aspx" SkinID="Checkout">[lnkCheckout]</asp:HyperLink>
                    </div>
