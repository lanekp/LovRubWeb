<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="TaxConfiguration.aspx.cs" Inherits="_Config_TaxConfiguration" Title="Tax Configuration" %>
...
<div id="centercontent">
   ...
   <div class="sectionheader">US State Jurisdiction Sales Tax</div>
    ...
    CKS does not currently offer a model for calculating non-us sales tax (EU VAT tax, etc.). Non-US rates seem to be quite complicated and frankly we just don’t know enough. We invite you to provide us feedback about various international tax laws and we will add support they are they requested.
       ...
       <tr>
        ...
        <tr>
            ...
            <td>
               ...
               <span class="adminlabel">
                In addition to state sales tax, many regions (cities, counties, etc.) require you to charge additional sales tax.  As described above, this makes calculating sales tax very complicated. dashCommerce simplifies the calculation by basing sales tax on the buyer’s zip code. This is very accurate, but not 100% accurate.
